...
type CommandArgs<T extends WarehouseCommand> = T extends "init"
  ? WH
  : T extends "store"
  ? XYWHP
  : T extends "locate"
...
type CommandReturns<T extends WarehouseCommand> = T extends "init"
  ? void
  : T extends "store"
  ? void
  : T extends "locate"
...
type CommandF<K extends WarehouseCommand> = (
  args: CommandArgs<K>
